...
public class RetailerPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rs = mydb.getRetailerData(user,pass);
        if(rs==null){
            Button btnregister = (Button)findViewById(R.id.btnRegister);
            btnregister.setEnabled(false);
            Toast test = Toast.makeText(this,"Sorry you are not logged in",Toast.LENGTH_LONG);
            test.show();
    ...
    public void done(View view){
        ...
        if ("".equals(fullName) || "".equals(email) || "".equals(username) || "".equals(password) || "".equals(address) || "".equals(contact)  || "".equals(crop) || "".equals(price) || "".equals(weight) || "".equals(days)) {
            ...
            boolean flag = mydb.insertRetailerContent(fullName, email, username, password, address, contact,crop,Integer.parseInt(weight),Integer.parseInt(days),Integer.parseInt(price));
            if(flag==true) {
