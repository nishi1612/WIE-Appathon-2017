...
public class RetailerLoggedIn extends AppCompatActivity {
    DBHelper mydb;
    Cursor rs;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_retailer_logged_in);
    ...
    /*public void post(View view){
        Intent intent = new Intent(this,RetailerPost.class);
